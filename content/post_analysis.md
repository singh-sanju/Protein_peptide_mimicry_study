...
- Binding free energy was estimated using the MM-GBSA approach @valdes2021gmx, to compare relative binding strengths among the peptides.


:::{note}Note

- Post-MD analysis scripts used for RMSD, RMSF, SASA and hydrogen bonds are available in the GitHub repository: /script/md/
- All the visual inspections were performed on VMD @humphrey1996vmd, and PyMol accordingly.
:::
